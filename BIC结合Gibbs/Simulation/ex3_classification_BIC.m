...
for i = 1:120
    ...
    NB_pro(1,i) = count*log(all_pios(1))-all_pios(1);
    NB_pro(2,i) = count*log(all_pios(2))-all_pios(2);
    NB_pro(3,i) = count*log(all_pios(3))-all_pios(3);
