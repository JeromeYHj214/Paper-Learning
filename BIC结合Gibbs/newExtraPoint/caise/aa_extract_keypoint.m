...
vl_version verbose
 folder = 'F:\BaiduNetdiskDownload\纹理数据集\UIUC14_brick1';         %14点数最多3 11
% folder = 'F:\BaiduNetdiskDownload\纹理数据集\UIUC20_upholstery';     %20容易出问题，基数属于中等 3 9
% folder ='F:\BaiduNetdiskDownload\纹理数据集\UIUC15_brick22';          %15点数最少3 11
...
for i = 1:length(filepaths)
    ...
    [f, d] = vl_sift(I,'Levels',3,'PeakThresh', 11);
    keypoint{3,i} = f;
    keypoint{4,i} = d;
    h = vl_plotframe(f);
