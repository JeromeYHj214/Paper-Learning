...
vl_version verbose
%folder = 'E:\BaiduNetdiskDownload\uiuc-texture-gray-256x256-CASIAV3names\T14_brick1';         %14点数最多 3 10
%folder = 'E:\BaiduNetdiskDownload\uiuc-texture-gray-256x256-CASIAV3names\T20_upholstery';     %20容易出问题，基数属于中等 2 10
folder ='E:\BaiduNetdiskDownload\uiuc-texture-gray-256x256-CASIAV3names\T15_brick2';          %15点数最少    2 14
...
for i = 1:length(filepaths)
    ...
    [f, d] = vl_sift(I,'Levels',1,'PeakThresh', 24);
    keypoint{3,i} = f;
    keypoint{4,i} = d;
    %     h = vl_plotframe(f);
