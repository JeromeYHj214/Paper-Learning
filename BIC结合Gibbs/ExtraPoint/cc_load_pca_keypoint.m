...
load T14c.mat; load T15c.mat; load T20c.mat;
...
%     cell_T20_point_train{3,i} = cell_T20_point{3,i};
% end
% MLE_T14card = MLE_T14card / (len-bb)
% MLE_T15card = MLE_T15card / (len-bb)
% MLE_T20card = MLE_T20card / (len-bb)
% %前十张作为测试
% for i = 1:10
%     %保存每张图像的基数信息
...
save('T14c_finalData.mat','cell_T14_point','cell_T14_point_text','cell_T14_point_train','MLE_T14card');
save('T15c_finalData.mat','cell_T15_point','cell_T15_point_text','cell_T15_point_train','MLE_T15card');
save('T20c_finalData.mat','cell_T20_point','cell_T20_point_text','cell_T20_point_train','MLE_T20card');