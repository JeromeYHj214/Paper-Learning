...
% T14_feat_pca = [T14_score(:,1) T14_score(:,2)];
save('T14c.mat','T14','T14_card','T14_feat','T14_feat_pca');

load T15c_brick2.mat;
T15 = keypoint;
T15_feat = [];
T15_card = [];
for i = 1:40
...
% T15_feat_pca = [T15_score(:,1) T15_score(:,2)];
save('T15c.mat','T15','T15_card','T15_feat','T15_feat_pca');

load T20c_upholstery;
T20 = keypoint;
T20_feat = [];
T20_card = [];
for i = 1:40
...
save('T20c.mat','T20','T20_card','T20_feat','T20_feat_pca');