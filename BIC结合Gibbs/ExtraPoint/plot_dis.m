...
hold on
plot(T15_feat_pca(:,1),T15_feat_pca(:,2),'.g');
hold on
plot(T20_feat_pca(:,1),T20_feat_pca(:,2),'.b');
set(gcf,'color','white');
ylabel('X_1');
xlabel('X_2');
